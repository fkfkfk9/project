<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<!-- 호서대 로고 이미지  절대경로 -->
	<div id="logo"><a href="/homepage/index.jsp"><img src="/homepage/img/hoseo_logo.png" border="0"></a></div>
	...
	<%
		...
		{
			%>
				<a href="/homepage/login/login_form.jsp"><%=userid %>로그인</a>  
			<%
		} //지울부분 미완성이라 주석과함꼐 넣음
		else{
		%><a href="/homepage/login/login_form.jsp"><%=userid %>로그아웃</a> <% } %>
		<%-- 
		else
		{
			%>
